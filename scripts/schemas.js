...
function buildSchemas() {
    ...
    const program = TJS.getProgramFromFiles([resolve('./node_modules/@acryl/acryl-transactions/dist/index.d.ts')], compilerOptions);


    TYPES.forEach(type => {
        const id = `https://raw.githubusercontent.com/acrylplatform/acryl-transactions/master/src/schemas/${type}.json`;
